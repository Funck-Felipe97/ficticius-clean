...
public class CalculoPrevisaoResourceIT {
    ...
    void testCalcularPrevisaoGastos1() throws Exception {
        mockMvc.perform(get("/api/v1/veiculos/calculo-gastos")
                ...
                .andExpect(jsonPath("$.[0].nome").value("Carro 1"))
                .andExpect(jsonPath("$.[0].marca").value("Chevrolet"))
                .andExpect(jsonPath("$.[0].modelo").value("Celta"))
                ...
                .andExpect(jsonPath("$.[1].nome").value("Carro 3"))
                .andExpect(jsonPath("$.[1].marca").value("Fiat"))
                .andExpect(jsonPath("$.[1].modelo").value("Uno"))
                ...
                .andExpect(jsonPath("$.[2].nome").value("Carro 2"))
                .andExpect(jsonPath("$.[2].marca").value("Volks"))
                .andExpect(jsonPath("$.[2].modelo").value("Fusca"))
